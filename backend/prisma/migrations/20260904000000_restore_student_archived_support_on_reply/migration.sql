...
-- A student's archive is an inbox preference, not a conversation lifecycle
-- state. A new WesBot or Staff reply returns the thread to the student's
-- active inbox in the same transaction that creates the reply.
